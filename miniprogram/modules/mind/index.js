const MIND_STATES = [
  {
    ...
    taboo: "不因开盘波动临时改规则。",
    practice: "今天只练：任何行动前写下理由、边界、离场条件。",
    position: "今日仓位边界：只允许轻仓验证，不因急躁放大动作。",
    reminder: "急不是机会，是心被盘面牵走的信号。"
  },
  {
    key: "tan",
    glyph: "贪",
    ...
    position: "今日仓位边界：仓位不因兴奋上调，只按盘前规则。",
    reminder: "贪念最会伪装成信心。"
  },
  {
    key: "ju",
    ...
    position: "今日仓位边界：只做系统允许的最小动作，保持可承受。",
  ...
  },
  {
    ...
    position: "今日仓位边界：疲惫日降低动作密度，避免被波动牵动。",
    reminder: "疲惫时最该守简。"
  },
  {
    key: "du",
    ...
    position: "今日仓位边界：不允许临场放大，不允许补偿式动作。",
  ...
  },
  {
    ...
    taboo: "不为了找存在感而行动。",
    practice: "今天只练：没有系统信号时，允许自己不做。",
    position: "今日仓位边界：空心日以观察为主，不为填补空白而动作。",
