...
const index = calculateDailyZhixingMvp({
  ...
  training7View: { completedCount: 2, progressPercent: 28, today: { title: "观风险处理抗拒", tasks: [{ done: true }, { done: true }, { done: true }] } }
});
...
assert.strictEqual(index.mainStage.name, "观风险处理抗拒");
