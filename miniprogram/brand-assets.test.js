...
assert.equal(homeWxml.includes("K线观心"), false, "home page should not expose the K-line shortcut")
assert.ok(trainingWxml.includes('bindtap="goKlineMind"'), "training page should keep the K-line training entry")
