...
assertRuleHas(klineMindWxss, ".sub-indicator-menu", ["bottom: 46rpx", "top: auto"], "kline indicator picker should open upward instead of being clipped below the chart");
assertRuleHas(klineMindWxss, ".sub-indicator-head > button", ["margin: 0"], "kline indicator picker should stay on the lower-left instead of centering");
