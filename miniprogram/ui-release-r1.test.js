...
assert.equal(klineMindWxml.includes('bindtap="panChartLeft"'), false, "kline chart should not render a separate left pan control after touch panning is available");
assert.equal(klineMindWxml.includes('bindtap="panChartRight"'), false, "kline chart should not render a separate right pan control after touch panning is available");
assert.equal(klineMindWxml.includes("‹"), false, "kline chart pan controls should not use bracket-like chevrons on real devices");
assert.equal(klineMindWxml.includes("›"), false, "kline chart pan controls should not use bracket-like chevrons on real devices");
assert.equal(klineMindWxml.includes("←"), false, "kline chart controls should not render left arrow glyphs in the compact zoom stepper");
assert.equal(klineMindWxml.includes("→"), false, "kline chart controls should not render right arrow glyphs in the compact zoom stepper");
assert.equal(klineMindWxml.includes("点箭头"), false, "kline chart gesture hint should not mention removed arrow controls");
assert.ok(klineMindWxml.includes("左右滑动平移"), "kline chart should explain touch panning after removing arrow controls");
