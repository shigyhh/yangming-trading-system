...
const seedPosts = [
  {
    ...
    content: [
      ...
      "心学里讲知行合一，放到交易里，就是知道风险以后，投入边界、风险处理和复盘也要跟上。每次下单前停一下：我现在是在按计划行动，还是在被恐惧、侥幸、急躁推着走？",
  ...
  },
  {
    id: "seed-risk-001",
    category: "risk",
    title: "为什么不先教进场点？先教投入边界和风险处理",
    summary: "进场点只解决入场，投入边界和风险处理决定一次错误会不会扩大。",
    content: [
      "交易教育最容易吸引人的，是进场点、形态和热闹故事。但真正决定普通用户能不能长期训练下去的，往往是投入边界和风险处理。",
      "如果一次错误会伤到本金和心态，后面的技术动作都会变形。先把单笔风险降下来，人才有余地复盘和修正。",
      "所以高风险人格不代表不能学习，而是训练顺序要换：先降投入、守纪律，再慢慢谈进攻。"
    ].join("\n\n"),
    tags: ["风险教育", "投入边界", "风险处理"],
    author_name: "知行学堂",
    view_count: 102,
