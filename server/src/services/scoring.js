...
const profiles = {
  ...
  扛单型: {
    ...
    scene: "最容易亏在跌破计划失效位、补仓摊低成本、幻想反弹时。",
    ability: "风险处理执行能力",
    camp: "风险修正营",
    reminder: "致良知不是让你硬扛，而是看见事实后立刻修正行动。",
    actions: ["给每笔持仓写清楚风险处理条件，没有条件不允许行动。", "盘中触发风险处理只做执行，不做辩论。", "把最近一笔扛单交易拆成三个节点：破位、犹豫、扩大亏损。", "设置亏损提醒，触线后先按计划处理一部分，避免情绪占满大脑。", "连续 7 天记录自己说过的“再等等”，看它是否真的保护你。", "用轻投入练习机械风险处理，目标是训练动作，不是追求盈利。", "复盘一条规则：亏损扩大前，我真正能控制的动作是什么。"]
  },
  完美主义型: {
  ...
  赌徒型: {
    ...
    actions: ["未来 7 天单次投入边界固定，任何理由不得突破。", "连续亏损两笔后停止交易一天。", "把回本念头写下来，标出它让你做过哪些危险动作。", "删除会诱发高频冲动的盘口提醒。", "只做一类低波动训练单，目标是控制手，不是刺激心。", "复盘一次重投入失败，计算如果按投入纪律会少亏多少。", "写一句提醒：小亏可控，大赌伤身。"]
  },
  拖延型: {
    pattern: "知道该做什么，却常在关键动作上慢半拍。",
    risk: "容易错过买卖点、复盘断档和计划长期停留在纸面。",
    scene: "最容易亏在该风险处理不处理、该复盘不复、该调整投入却拖到收盘后。",
    ability: "关键动作启动能力",
    camp: "执行强化营",
    reminder: "知而不行，只是未知。把一个动作做出来，认知才真正落地。",
    actions: ["每天只设一个必须完成的交易动作，并在收盘前打勾。", "风险处理、减量、复盘都设置固定时间提醒。", "把复杂计划拆成 5 分钟能完成的小动作。", "复盘最近一次拖延，找出拖延前的真实念头。", "用模拟盘训练触发条件后的立即执行。", "建立交易日志模板，减少开始复盘的阻力。", "写一句提醒：今天完成一个动作，胜过想清十个道理。"]
  },
  平衡型: {
